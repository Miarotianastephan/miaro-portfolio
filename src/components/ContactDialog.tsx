...
/* 
    Assets
*/
import { SendIcon, CheckIcon, CircleAlertIcon, Loader2Icon } from "lucide-react";
...
export const ContactDialog = ({ open, onOpen }: ContactDialogProps) => {
    ...
    const sendEmail: SubmitEventHandler<HTMLFormElement> 
    = useCallback(async (e) => {
        e.preventDefault()
                ...
                >
                    ...
                    <div className="space-y-2">
                        ...
                        <Input 
                            ...
                            type="email" 
                            name="email"
                            placeholder="simple@contact.com" 
                            required
                        />
                    </div>
